            ...
            >
                ...
                >
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <button
                            type="button"
                            @click="panelDatos = true"
                            class="shrink-0 rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-bold text-slate-700 transition hover:bg-slate-50"
                        >
                            Editar datos
                        </button>
                    </div>
                ...
                >
                    ...
                    <div class="mt-2 flex items-end justify-between">
                        ...
                        <Boxes class="h-6 w-6 text-slate-300" />
                    </div>
                </div>

                <!-- Total -->
                <div
                    class="rounded-3xl border border-emerald-200 bg-emerald-50 p-5 shadow-sm"
                >
                    <p
                    ...
                    <p
                        class="mt-2 font-mono text-2xl font-black text-emerald-800 tabular-nums"
                    >
