                ...
                >
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-slate-500">
                                    Tipo:
                                    <span
                                        class="inline-flex items-center rounded-lg bg-emerald-50 px-2 py-0.5 text-xs font-semibold text-emerald-700 ring-1 ring-emerald-100"
                                    >
                                        {{ nombreTipo }}
                                    </span>
                                </p>
                    ...
                    >
                        ...
                        >
                            ...
                            {{ editando ? "Guardar" : "Agregar valor" }}
                        </button>
                    </div>
                </div>
            </div>
...
import BaseInput from "@/components/ui/BaseInput.vue"; // <-- ajusta ruta
...
const props = defineProps({
    ...
    nombreTipo: { type: String, default: "" },
    placeholder: { type: String, default: "Escribe el valor…" },
    valor: { type: String, default: "" },
    activo: { type: Boolean, default: true },
});

const emit = defineEmits(["close", "submit", "update:valor", "update:activo"]);

const valorProxy = computed({
    get: () => props.valor,
    set: (v) => emit("update:valor", v),
});
