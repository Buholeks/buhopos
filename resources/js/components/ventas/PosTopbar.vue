        ...
        Operaciones rápidas para la venta y la caja
                ...
                <div class="flex flex-wrap items-center gap-2">
                    <div
                        ...
                        class="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-600"
                    >
                    ...
                    <div
                        ...
                        class="inline-flex items-center gap-2 rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-2 text-sm"
                    >
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <button
                    ...
                    @click="$emit('enEspera')"
                >
                    <PauseCircle class="h-4 w-4 text-amber-600" />
                    En espera
                ...
                <div class="mx-1 hidden h-6 w-px bg-slate-200 lg:block" />
