<template>
    ...
    >
        <div class="mx-auto flex max-w-7xl flex-col gap-1.5 px-3 py-1.5">
            <!-- Fila superior -->
            <div
                class="flex flex-col gap-1.5 lg:flex-row lg:items-center lg:justify-between"
            >
                <!-- Izquierda -->
                <div class="flex min-w-0 items-center gap-2">
                    <div
                        class="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-emerald-100 text-emerald-600"
                    >
            ...
            <div class="flex flex-wrap items-center gap-1.5">
                ...
                <button
                    v-if="!cajaAbierta"
                    type="button"
                    class="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-2 py-1 text-xs font-medium text-slate-700 shadow-sm transition hover:bg-slate-50"
                ...
                <button
                    type="button"
                    class="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-2 py-1 text-xs font-medium text-slate-700 shadow-sm transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50"
                ...
                <button
                    type="button"
                    class="inline-flex items-center gap-1.5 rounded-lg bg-emerald-600 px-2.5 py-1 text-xs font-semibold text-white shadow-sm transition hover:bg-emerald-700 disabled:cursor-not-allowed disabled:opacity-50"
