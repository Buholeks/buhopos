...
<style>
    @page { size: auto; margin: ${margen}mm; }
    * { box-sizing: border-box; }
    ...
    .producto { break-inside: avoid; page-break-inside: avoid; padding: 1mm 0; border-bottom: 1px dotted #cbd5e1; }
    ...
    .total { break-inside: avoid; page-break-inside: avoid; margin: 1mm 0; padding: 1.5mm 2mm; color: #fff; background: #0f172a; font-size: 12px; font-weight: 800; display: flex; justify-content: space-between; }
...
function renderCanvasHtml(elementos, ticket, altoMm, interiorMm) {
    ...
    return `<div style="position:relative;width:100%;height:${altoMm}mm;overflow:visible;break-inside:avoid;">${items}</div>`;
}
...
function renderElementoHtml(el, ticket) {
    ...
    return `<div data-ticket-text style="${base}font-size:${el.fuente || 10}pt;font-weight:${el.negrita ? 700 : 400};font-family:${ff};text-align:${alin};display:flex;align-items:center;"><span style="width:100%;overflow-wrap:anywhere;">${val}</span></div>`;
}
...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .producto { break-inside: avoid; page-break-inside: avoid; padding: 3px 0; border-bottom: 1px dotted #cbd5e1; }
    ...
    .fila span:last-child { white-space: nowrap; font-weight: 700; }
    .total { break-inside: avoid; page-break-inside: avoid; margin: 3px 0; padding: 3px 5px; color: #fff; background: #0f172a; font-size: 13px; font-weight: 800; }
