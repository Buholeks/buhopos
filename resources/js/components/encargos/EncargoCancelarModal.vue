            ...
            <div class="space-y-3 p-5">
                ...
                <div v-if="tieneAnticipo" class="space-y-3 rounded-xl border border-slate-200 bg-slate-50 p-3">
                    ...
                    >
                        ...
                        <option value="transferencia">Devolver por transferencia</option>
                    </select>

                    <div v-if="requiereDevolucion" class="space-y-2">
                        <label class="block text-xs font-black uppercase tracking-wide text-slate-500">Monto a devolver</label>
                        <input
...
const puedeConfirmar = computed(() => {
    ...
    if (Number(form.monto_devolucion || 0) <= 0) return false;
...
watch(
    ...
    () => {
        ...
        form.monto_devolucion = Number(props.pedido?.anticipo || 0);
...
watch(
    ...
    (destino) => {
        ...
        if (destino === "mantener_saldo") form.monto_devolucion = Number(props.pedido?.anticipo || 0);
    },
);
